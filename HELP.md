...
* The original package name 'com.cicd.ci-cd-application-springboot-java-app' is invalid and this project uses 'com.cicd.cicdapplicationspringbootjavaapp' instead.
